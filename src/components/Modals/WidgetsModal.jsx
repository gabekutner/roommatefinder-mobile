...
export default function WidgetsModal({isVisible, setIsVisible, text}) {
            ...
            >
              ...
              >
                ...
                >
                  <CustomText
                    fontSize="medium"
                    style={{color: colors.tint, fontWeight: "500"}}
                  >
                    {prompt.answer}
                  </CustomText>
                </View>
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <View style={{marginTop: verticalScale(20)}}>{whatToRender()}</View>
        </View>
      </View>
    </Modal>
  );
