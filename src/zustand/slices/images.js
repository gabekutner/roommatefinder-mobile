      ...
      try {
        ...
        if (form.photo_1 !== null) {
          ...
          dataForm.append("image", {
            name: fileName,
            type:
              Platform.OS === "ios" ? form.photo_1.type : "image/" + fileType,
            uri:
              Platform.OS === "android"
                ? form.photo_1.uri
        ...
        if (form.photo_2 !== null) {
          ...
          dataForm.append("image", {
            name: fileName,
            type:
              Platform.OS === "ios" ? form.photo_2.type : "image/" + fileType,
            uri:
              Platform.OS === "android"
                ? form.photo_2.uri
        ...
        if (form.photo_3 !== null) {
          ...
          dataForm.append("image", {
            name: fileName,
            type:
              Platform.OS === "ios" ? form.photo_3.type : "image/" + fileType,
            uri:
              Platform.OS === "android"
                ? form.photo_3.uri
      ...
      try {
        ...
        if (form.thumbnail.uri !== null) {
          ...
          dataForm.append("thumbnail", {
            name: fileName,
            type:
              Platform.OS === "ios" ? form.thumbnail.type : "image/" + fileType,
            uri:
              Platform.OS === "android"
                ? form.thumbnail.uri
