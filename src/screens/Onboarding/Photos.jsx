...
export default function PhotosScreen({del}) {
  ...
  return (
    <>
      <CustomText
        fontSize="medium"
        style={{marginVertical: verticalScale(10), fontWeight: "500"}}
      >
