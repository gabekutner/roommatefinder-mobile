  ...
  const InfoItem = ({icon, text}) => {
    return (
      ...
      >
        ...
        <CustomText
          fontSize="medium"
          style={{fontWeight: "500", color: colors.tertiary}}
        >
          {text}
        </CustomText>
      </View>
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.wrapper}>
          ...
          >
            <CustomText fontSize="x-large" style={styles.title}>
              {item.name}, {item.age}
            </CustomText>
            <CustomButton
              shadow
        ...
        <View style={styles.wrapper}>
          <InfoItem
            icon="building"
            text={dormsData[item.dorm_building - 1].dorm}
          />
          <View
            style={{
              borderWidth: 0.5,
        ...
        {item.description ? (
          <View style={styles.wrapper}>
            ...
            >
              ...
              <CustomText
                fontSize="large"
                style={{fontWeight: "600", color: colors.tint}}
              >
                About me
              </CustomText>
            </View>
