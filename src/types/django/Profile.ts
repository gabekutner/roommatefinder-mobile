...
type Profile = {
  ...
  /** JWT Token for the current profile. */
  token: string;

  /** Access Token for the current profile. */
  access: string;

  /** Refresh Token for the current profile. */
  refresh:string;

  /** The roommate matching quiz for the current profile. */
  roommate_quiz: object;
};
